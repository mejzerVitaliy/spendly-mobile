          ...
          return (
            <>
              <Pressable
                ...
                className="flex-row items-center justify-between border border-border px-4 bg-input"
                style={{ minHeight: 50, paddingVertical: 14, borderRadius: 16 }}
              >
              ...
              <BottomSheet ref={sheetRef} snapPoints={['50%']}>
                <View className="px-4 pt-2 pb-4">
                  <Text className="text-lg font-semibold text-foreground mb-3">{t('transaction.selectDate')}</Text>
                  <Calendar
